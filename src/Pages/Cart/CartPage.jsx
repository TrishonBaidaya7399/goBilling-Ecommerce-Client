...
const CartPage = () => {
  return (
    <div className="">
      <AddNewCustomer />
      <CartItems />
      <div className="ml-auto w-[40%] text-gray-500 text-md mt-6">
      ...
      <div className="flex gap-2 mt-2">
        <div className="rounded-md flex items-center gap-1 text-xl w-full px-3 py-2 font-semibold bg-red-500/30 text-red-400 ">
            <p className="text-3xl"><IoMdCloseCircleOutline /></p>
            <p>Cancel</p>
        </div>
        <div className="rounded-md flex items-center gap-1 text-xl w-full px-3 py-2 font-semibold custom-bg-color custom-text-color">
